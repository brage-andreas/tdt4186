...
printint(int fd, int xx, int base, int sgn)
{
 ...
 786:	87e68693          	addi	a3,a3,-1922 # 1000 <digits>
...
printptr(int fd, uint64 x) {
 ...
 85a:	7aa70713          	addi	a4,a4,1962 # 1000 <digits>
...
malloc(uint nbytes)
{
 ...
 d72:	2c278793          	addi	a5,a5,706 # 1030 <freep>
 d76:	639c                	ld	a5,0(a5)
 ...
 d86:	29e78793          	addi	a5,a5,670 # 1020 <base>
 ...
 da0:	29478793          	addi	a5,a5,660 # 1030 <freep>
 da4:	6398                	ld	a4,0(a5)
 ...
 db4:	27078793          	addi	a5,a5,624 # 1020 <base>
 ...
 e2e:	20678793          	addi	a5,a5,518 # 1030 <freep>
 ...
 e44:	1f078793          	addi	a5,a5,496 # 1030 <freep>
 e48:	639c                	ld	a5,0(a5)
