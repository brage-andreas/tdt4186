...
printint(int fd, int xx, int base, int sgn)
{
 ...
 81e:	00000697          	auipc	a3,0x0
 822:	7e268693          	addi	a3,a3,2018 # 1000 <digits>
...
morecore(uint nu)
{
 ...
 dcc:	07c1                	addi	a5,a5,16 # 1010 <digits+0x10>
 dce:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
 ...
 eca:	36a78793          	addi	a5,a5,874 # 1230 <freep>
 ...
 ee0:	35478793          	addi	a5,a5,852 # 1230 <freep>
 ee4:	639c                	ld	a5,0(a5)
