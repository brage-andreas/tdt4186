...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6b6:	94e68693          	addi	a3,a3,-1714 # 1000 <digits>
...
printptr(int fd, uint64 x) {
 ...
 78a:	87a70713          	addi	a4,a4,-1926 # 1000 <digits>
...
free(void *ap)
{
 ...
 af6:	53e78793          	addi	a5,a5,1342 # 1030 <freep>
 afa:	639c                	ld	a5,0(a5)
...
malloc(uint nbytes)
{
 ...
 ca2:	39278793          	addi	a5,a5,914 # 1030 <freep>
 ca6:	639c                	ld	a5,0(a5)
 ...
 cb6:	36e78793          	addi	a5,a5,878 # 1020 <base>
 ...
 cda:	34a78793          	addi	a5,a5,842 # 1020 <base>
 cde:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 ce0:	00000797          	auipc	a5,0x0
 ce4:	34078793          	addi	a5,a5,832 # 1020 <base>
 ...
 d5e:	2d678793          	addi	a5,a5,726 # 1030 <freep>
