...
printint(int fd, int xx, int base, int sgn)
{
 ...
 68a:	97a68693          	addi	a3,a3,-1670 # 1000 <digits>
...
printptr(int fd, uint64 x) {
 ...
 75e:	8a670713          	addi	a4,a4,-1882 # 1000 <digits>
...
free(void *ap)
{
 ...
 aca:	56a78793          	addi	a5,a5,1386 # 1030 <freep>
 ace:	639c                	ld	a5,0(a5)
 ...
 bc2:	47278793          	addi	a5,a5,1138 # 1030 <freep>
...
morecore(uint nu)
{
 ...
 c34:	07c1                	addi	a5,a5,16 # 1010 <digits+0x10>
 c36:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
 ...
 c76:	3be78793          	addi	a5,a5,958 # 1030 <freep>
 c7a:	639c                	ld	a5,0(a5)
 ...
 c8a:	39a78793          	addi	a5,a5,922 # 1020 <base>
 ...
 d32:	30278793          	addi	a5,a5,770 # 1030 <freep>
 ...
 d48:	2ec78793          	addi	a5,a5,748 # 1030 <freep>
 d4c:	639c                	ld	a5,0(a5)
