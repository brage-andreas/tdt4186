...
printptr(int fd, uint64 x) {
 ...
 77c:	88870713          	addi	a4,a4,-1912 # 1000 <digits>
...
free(void *ap)
{
 ...
 ae8:	54c78793          	addi	a5,a5,1356 # 1030 <freep>
 aec:	639c                	ld	a5,0(a5)
...
morecore(uint nu)
{
 ...
 c52:	07c1                	addi	a5,a5,16 # 1010 <digits+0x10>
 c54:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
 ...
 c94:	3a078793          	addi	a5,a5,928 # 1030 <freep>
 c98:	639c                	ld	a5,0(a5)
 ...
 ca8:	37c78793          	addi	a5,a5,892 # 1020 <base>
 ...
 d66:	2ce78793          	addi	a5,a5,718 # 1030 <freep>
 d6a:	639c                	ld	a5,0(a5)
