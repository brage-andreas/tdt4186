...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    14fe:	b1668693          	addi	a3,a3,-1258 # 2010 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    15d2:	a4270713          	addi	a4,a4,-1470 # 2010 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    193e:	aee78793          	addi	a5,a5,-1298 # 2428 <freep>
  ...
  freep = p;
    ...
    1a36:	9f678793          	addi	a5,a5,-1546 # 2428 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1ab8:	97478793          	addi	a5,a5,-1676 # 2428 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1aea:	94278793          	addi	a5,a5,-1726 # 2428 <freep>
    ...
    1afe:	91e78793          	addi	a5,a5,-1762 # 2418 <base>
    ...
    1b18:	91478793          	addi	a5,a5,-1772 # 2428 <freep>
    1b1c:	6398                	ld	a4,0(a5)
    1b1e:	00001797          	auipc	a5,0x1
    1b22:	8fa78793          	addi	a5,a5,-1798 # 2418 <base>
    1b26:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    1b28:	00001797          	auipc	a5,0x1
    1b2c:	8f078793          	addi	a5,a5,-1808 # 2418 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1ba6:	88678793          	addi	a5,a5,-1914 # 2428 <freep>
    ...
    1bbc:	87078793          	addi	a5,a5,-1936 # 2428 <freep>
