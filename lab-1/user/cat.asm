...
printint(int fd, int xx, int base, int sgn)
{
 ...
 77c:	88868693          	addi	a3,a3,-1912 # 1000 <digits>
...
printptr(int fd, uint64 x) {
 ...
 850:	7b470713          	addi	a4,a4,1972 # 1000 <digits>
...
free(void *ap)
{
 ...
 bbc:	67878793          	addi	a5,a5,1656 # 1230 <freep>
 bc0:	639c                	ld	a5,0(a5)
 ...
 cb4:	58078793          	addi	a5,a5,1408 # 1230 <freep>
...
malloc(uint nbytes)
{
 ...
 d68:	4cc78793          	addi	a5,a5,1228 # 1230 <freep>
 d6c:	639c                	ld	a5,0(a5)
 ...
 d7c:	4a878793          	addi	a5,a5,1192 # 1220 <base>
 ...
 d96:	49e78793          	addi	a5,a5,1182 # 1230 <freep>
 d9a:	6398                	ld	a4,0(a5)
 ...
 daa:	47a78793          	addi	a5,a5,1146 # 1220 <base>
 ...
 e24:	41078793          	addi	a5,a5,1040 # 1230 <freep>
 ...
 e3a:	3fa78793          	addi	a5,a5,1018 # 1230 <freep>
 e3e:	639c                	ld	a5,0(a5)
