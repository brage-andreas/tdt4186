...
printint(int fd, int xx, int base, int sgn)
{
 ...
 71c:	8f868693          	addi	a3,a3,-1800 # 1010 <digits>
...
printptr(int fd, uint64 x) {
 ...
 7f0:	82470713          	addi	a4,a4,-2012 # 1010 <digits>
...
free(void *ap)
{
 ...
 b5c:	4e878793          	addi	a5,a5,1256 # 1040 <freep>
 b60:	639c                	ld	a5,0(a5)
 ...
 c54:	3f078793          	addi	a5,a5,1008 # 1040 <freep>
...
malloc(uint nbytes)
{
 ...
 d08:	33c78793          	addi	a5,a5,828 # 1040 <freep>
 d0c:	639c                	ld	a5,0(a5)
 ...
 d1c:	31878793          	addi	a5,a5,792 # 1030 <base>
 ...
 d36:	30e78793          	addi	a5,a5,782 # 1040 <freep>
 d3a:	6398                	ld	a4,0(a5)
 ...
 d4a:	2ea78793          	addi	a5,a5,746 # 1030 <base>
 ...
 dc4:	28078793          	addi	a5,a5,640 # 1040 <freep>
 ...
 dda:	26a78793          	addi	a5,a5,618 # 1040 <freep>
 dde:	639c                	ld	a5,0(a5)
