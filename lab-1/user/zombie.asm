...
printint(int fd, int xx, int base, int sgn)
{
 ...
 626:	9de68693          	addi	a3,a3,-1570 # 1000 <digits>
...
printptr(int fd, uint64 x) {
 ...
 6fa:	90a70713          	addi	a4,a4,-1782 # 1000 <digits>
...
free(void *ap)
{
 ...
 a66:	5ce78793          	addi	a5,a5,1486 # 1030 <freep>
 a6a:	639c                	ld	a5,0(a5)
 ...
 b5e:	4d678793          	addi	a5,a5,1238 # 1030 <freep>
...
malloc(uint nbytes)
{
 ...
 c12:	42278793          	addi	a5,a5,1058 # 1030 <freep>
 c16:	639c                	ld	a5,0(a5)
 ...
 c26:	3fe78793          	addi	a5,a5,1022 # 1020 <base>
 ...
 c40:	3f478793          	addi	a5,a5,1012 # 1030 <freep>
 c44:	6398                	ld	a4,0(a5)
 ...
 c54:	3d078793          	addi	a5,a5,976 # 1020 <base>
 ...
 ce4:	35078793          	addi	a5,a5,848 # 1030 <freep>
 ce8:	639c                	ld	a5,0(a5)
